package com.dicoding.sub2github.receiver
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    private fun sendNotification(context: Context) {
        val intent = context?.packageManager.getLaunchIntentForPackage("com.dicoding.sub2github")
        ...
        val builder = NotificationCompat.Builder(context, CHANNEL_ID)
            ...
            .setContentText("Cari user Favorite anda sekarang")
            .setAutoCancel(true)
