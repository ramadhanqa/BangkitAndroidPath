...
class AlarmReceiver : BroadcastReceiver() {
    ...
    fun showAlarmNotification(context: Context, title: String, message: String, notifId: Int) {
        ...
        val intent = context?.packageManager.getLaunchIntentForPackage("com.dicoding.sub3github")
...
//                intent
    ...
    fun showAlarmNotificationNotIntent(
        context: Context,
        title: String,
        message: String,
        notifId: Int
    ...
    fun setRepeatingAlarm(context: Context, type: String, time: String, message: String) {
        ...
        Toast.makeText(context, "Alarm di set pukul 09:00 am", Toast.LENGTH_SHORT).show()
    }


    fun cancelAlarm(context: Context, type: String) {
        val title = "Reminder Alarm"
        val notifId =
            if (type.equals(TYPE_ONE_TIME, ignoreCase = true)) ID_ONETIME else ID_REPEATING
        val alarmManager = context.getSystemService(Context.ALARM_SERVICE) as AlarmManager
        val intent = Intent(context, AlarmReceiver::class.java)
        ...
        showAlarmNotificationNotIntent(context, title, "Alarm dibatalkan", notifId)
    }
}
